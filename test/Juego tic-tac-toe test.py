...
& after
https://edube.org/learn/python-essentials-1/project-tic-tac-toe-1
...
from Juego_Tictactoe import JuegoTictactoe




class JuegoTictactoeTest(unittest.TestCase):
    def test_empty_display_board(self):
        tic_tac_toe = JuegoTictactoe()
        self.assertEqual(tic_tac_toe.display_board(), 0)

    def test_print_display_board(self):
        tic_tac_toe = JuegoTictactoe()
        self.assertEqual(tic_tac_toe.display_board(), 1)
...
# python "D:\Python programas\Game tic-tac-toe.py"
